    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-100 dark:from-[#0e0e10] dark:via-[#171725] dark:to-[#202032] transition-all duration-700">
      ...
      <main className="container mx-auto pt-28 pb-20 px-6 text-center space-y-10">
        ...
        <motion.div
          ...
          className="space-y-3"
        >
          <h1 className="flex justify-center items-center gap-3 text-5xl md:text-6xl font-bold bg-gradient-to-r from-purple-500 via-pink-500 to-indigo-500 text-transparent bg-clip-text">
            <Palette className="h-10 w-10" /> Doodle Pad
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto font-medium">
            Relax, draw, and let your imagination flow — a mindful creative experience 🎨
          </p>
        </motion.div>

        {/* 🖌️ DoodlePad Container */}
        <motion.div
        ...
        >
          {/* Floating Brush Emoji for subtle life */}
          <motion.div
