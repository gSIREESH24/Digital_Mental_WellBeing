...
import { KaleidoscopeDrawer } from "@/components/KaleidoscopeDrawer";
    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-100 dark:from-[#0e0e10] dark:via-[#171725] dark:to-[#202032] transition-all duration-700">
      ...
      <main className="container mx-auto pt-28 pb-20 px-6 text-center space-y-10">
        <motion.div
          ...
          className="space-y-3"
        >
          <h1 className="flex justify-center items-center gap-3 text-5xl md:text-6xl font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-transparent bg-clip-text">
            <Compass className="h-10 w-10" /> Kaleidoscope Drawer
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto font-medium">
            Watch reflections dance and form hypnotic patterns with every stroke.
          </p>
        </motion.div>
        ...
        >
          <Link href="/creative-tools">
            <Button
              variant="outline"
              className="rounded-full px-6 py-3 text-lg font-semibold border-2 border-indigo-400/40 text-indigo-700
              dark:text-indigo-300 hover:bg-indigo-100/30 dark:hover:bg-indigo-900/30 hover:scale-105 hover:border-indigo-500
